...
public class Install
{
     ...
     * @throws java.io.FileNotFoundException if the agent jar cannot be found using the environment variable BYTEMAN_HOME
     * or the System property org.jboss.byteman.home and cannot be located in the current classpath
     * @throws java.io.IOException if the byteman jar cannot be opened or uploaded to the requested JVM
